...
time_spam := cooldown_spam//1000
Mod(cooldown_spam, 1000)
;/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Gui, Add, Text, cWhite x10 y39 w200 h35, Режимы работы скрипта:
Gui, Add, Text, cWhite x10 y65 w230 h35, Отправка раз в %time% cекунд
Gui, Add, Text, cWhite x10 y95 w230 h35, Спам и спам рнд - %time_spam% секунд
Gui, Add, Text, cWhite x10 y139 w200 h35, Запуск - /start 
Gui, Add,Text, cRed x140 y139, [Работает]
Gui, Add, Text, cWhite x10 y169 w220 h35, Спам - /spam
Gui, Add,Text, cRed x140 y169, [Работает]
Gui, Add, Text, cWhite x10 y199 w220 h35, Спам рнд - /rnd
Gui, Add,Text, cRed x140 y199, [Работает]
...
GenerateRandomString(length = 256) 
{

characters := "abcdefghijklmnopqurstuvwxyz0123456789ABCDEFGHIJKLMNOPQURSTUVWXYZ" 
StringSplit, chars, characters

Loop, %length%
{
	Random, rand, 1, 62 ; Без заглавных - 36
	rndstring .= chars%rand%
}
return rndstring
}
return
...
loop {
	...
	sleep 150
	ControlSend,, % GenerateRandomString(), ahk_pid %minecraftPID%
	sleep 100
